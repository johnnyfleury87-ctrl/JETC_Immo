      ...
      <Card>
        ...
        <div style={{
          ...
          <Card className="hover-glow" style={{
            ...
            <h2 style={{ fontSize: "2.5rem", margin: 0 }}>{stats.entreprises}</h2>
            <p style={{ margin: "0.5rem 0 0 0", opacity: 0.9 }}>🔧 Entreprises</p>
          </Card>
          ...
          <Card className="hover-glow" style={{
            ...
            <h2 style={{ fontSize: "2.5rem", margin: 0 }}>{stats.locataires}</h2>
            <p style={{ margin: "0.5rem 0 0 0", opacity: 0.9 }}>👤 Locataires</p>
          </Card>
          ...
          <Card className="hover-glow" style={{
            ...
            <h2 style={{ fontSize: "2.5rem", margin: 0 }}>{stats.techniciens}</h2>
            <p style={{ margin: "0.5rem 0 0 0", opacity: 0.9 }}>⚙️ Techniciens</p>
          </Card>
          ...
          <Card className="hover-glow" style={{
            ...
            <h2 style={{ fontSize: "2.5rem", margin: 0 }}>{stats.ticketsActifs}</h2>
            <p style={{ margin: "0.5rem 0 0 0", opacity: 0.9 }}>🎫 Tickets actifs</p>
          </Card>
          ...
          <Card className="hover-glow" style={{
            ...
            <h2 style={{ fontSize: "2.5rem", margin: 0 }}>{stats.missionsEnCours}</h2>
        ...
        <Card style={{ marginBottom: "2rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem" }}>
            <div style={{ textAlign: "center", padding: "1rem", background: "var(--background)", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "2rem", margin: 0, color: "var(--primary)" }}>{statsMonthly.crees}</h3>
              <p style={{ margin: "0.5rem 0 0 0", opacity: 0.7 }}>Tickets créés</p>
            </div>
            <div style={{ textAlign: "center", padding: "1rem", background: "var(--background)", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "2rem", margin: 0, color: "var(--green)" }}>{statsMonthly.resolus}</h3>
              <p style={{ margin: "0.5rem 0 0 0", opacity: 0.7 }}>Tickets résolus</p>
            </div>
            <div style={{ textAlign: "center", padding: "1rem", background: "var(--background)", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "2rem", margin: 0, color: "var(--accent)" }}>{statsMonthly.ratio}%</h3>
              <p style={{ margin: "0.5rem 0 0 0", opacity: 0.7 }}>Taux de résolution</p>
            </div>
          </div>
        </Card>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "var(--background)", borderBottom: "2px solid var(--primary)" }}>
                    <th style={{ padding: "0.75rem", textAlign: "left" }}>Entreprise</th>
                    <th style={{ padding: "0.75rem", textAlign: "center" }}>Missions traitées</th>
                ...
                <tbody>
                  {topEntreprises.map((entreprise, index) => (
                    <tr key={index} style={{ borderBottom: "1px solid rgba(0,0,0,0.1)" }}>
                      <td style={{ padding: "0.75rem" }}>{entreprise.nom || "N/A"}</td>
                      <td style={{ padding: "0.75rem", textAlign: "center" }}>{entreprise.missions_traitees || 0}</td>
                      <td style={{ padding: "0.75rem", textAlign: "center" }}>
                        <span style={{ 
                          background: entreprise.taux_reussite >= 80 ? "var(--green)" : "var(--orange)",
                          color: "white",
          ...
          {topRegies.length === 0 ? (
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "var(--background)", borderBottom: "2px solid var(--primary)" }}>
                    <th style={{ padding: "0.75rem", textAlign: "left" }}>Régie</th>
                    <th style={{ padding: "0.75rem", textAlign: "center" }}>Tickets créés</th>
                    <th style={{ padding: "0.75rem", textAlign: "center" }}>Taux résolu</th>
                  </tr>
                </thead>
                <tbody>
                  {topRegies.map((regie, index) => (
                    <tr key={index} style={{ borderBottom: "1px solid rgba(0,0,0,0.1)" }}>
                      <td style={{ padding: "0.75rem" }}>{regie.nom || "N/A"}</td>
                      <td style={{ padding: "0.75rem", textAlign: "center" }}>{regie.tickets_crees || 0}</td>
                      <td style={{ padding: "0.75rem", textAlign: "center" }}>
                        <span style={{ 
                          background: regie.taux_resolu >= 80 ? "var(--green)" : "var(--orange)",
                          color: "white",
                          padding: "0.25rem 0.5rem",
                          borderRadius: "4px",
                          fontWeight: "600"
