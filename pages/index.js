    ...
    <div style={{ 
      ...
      <section style={{ 
        ...
        <div style={{ 
          ...
          <Card className="hover-glow" style={{ textAlign: "center", padding: "2rem" }}>
            <div style={{ fontSize: "4rem", marginBottom: "1rem" }}>🏢</div>
            <h3 style={{ fontSize: "1.5rem", margin: "0 0 1rem 0", color: "var(--primary)" }}>
              Régies Immobilières
            </h3>
            <p style={{ opacity: 0.8, lineHeight: "1.6" }}>
              Gérez vos immeubles, logements et locataires. 
              Diffusez les tickets aux entreprises partenaires. 
              Suivez les interventions en temps réel.
            </p>
            <ul style={{ 
              textAlign: "left", 
              padding: "0 1rem",
          ...
          <Card className="hover-glow" style={{ textAlign: "center", padding: "2rem" }}>
            ...
            <p style={{ opacity: 0.8, lineHeight: "1.6" }}>
              Recevez les tickets des régies partenaires. 
              Assignez vos techniciens. 
              Gérez les factures et les reportings.
            </p>
            <ul style={{ 
              textAlign: "left", 
              padding: "0 1rem",
          ...
          <Card className="hover-glow" style={{ textAlign: "center", padding: "2rem" }}>
            ...
            <p style={{ opacity: 0.8, lineHeight: "1.6" }}>
              Consultez vos missions du jour. 
              Ajoutez des photos et signatures. 
      ...
      <footer style={{ 
        ...
        <div style={{ marginTop: "1rem" }}>
          <a 
            href="/pricing" 
            style={{ margin: "0 1rem", color: "var(--primary)", textDecoration: "none" }}
          >
            Tarifs
          </a>
          <a 
