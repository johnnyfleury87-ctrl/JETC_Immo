  ...
  return (
    <Layout>
      <div className="card fade-in">
        ...
        {showForm && (
          <form onSubmit={handleCreateTicket} style={{ marginBottom: "2rem", padding: "1rem", border: "1px solid #ddd" }}>
            <label>Titre</label>
            <input 
              type="text" 
              value={titre}
            ...
            <button type="submit" className="btn hover-glow click-scale">Créer</button>
          </form>
        )}
              ...
              <ul>
                {tickets.map((ticket) => (
                  <li key={ticket.id} style={{ marginBottom: "1rem", padding: "1rem", border: "1px solid #ddd" }}>
                    ...
                    <p>Date : {new Date(ticket.date_creation).toLocaleDateString()}</p>
                  </li>
                ))}
              </ul>
            )}
